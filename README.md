...
To update the database use this command from the Web project folder (replace `WebDownloadr` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../WebDownloadr.Infrastructure/WebDownloadr.Infrastructure.csproj -s WebDownloadr.Web.csproj
```
